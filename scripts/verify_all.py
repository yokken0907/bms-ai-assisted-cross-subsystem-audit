...
run([sys.executable,str(ROOT/'scripts/verify_repository.py')]); run([sys.executable,str(ROOT/'scripts/verify_witness_hashes.py')]); run([sys.executable,str(ROOT/'scripts/verify_publication_invariants.py')])
source=a.source_zip
if a.fetch_source:
