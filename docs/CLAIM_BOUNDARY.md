...
## Publication Version 1.1 clarification

The publication-facing set additionally avoids standalone wording that could imply external independent replication. Verification described as separated or implementation-independent is project-internal implementation separation unless explicitly stated otherwise. Patent documents are used only for technical-pattern orientation/mapping.
